...
class HelloTriangleApplication {
    ...
    private:
        ...
        void createGraphicsPipeline() {
            auto vertShaderCode = readFile("main.vert.spv");
            auto fragShaderCode = readFile("main.frag.spv");
#if USE_POINT_PRIMITIVE
            auto geomShaderCode = readFile("gen_traingles.geom.spv");
#else
            auto geomShaderCode = readFile("main.geom.spv");
#endif
            auto tescShaderCode = readFile("main.tesc.spv");
            auto teseShaderCode = readFile("main.tese.spv");
